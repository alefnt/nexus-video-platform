// FILE: /video-platform/client-web/src/pages/YouTubeCallback.tsx
    ...
    React.useEffect(() => {
        (async () => {
            try {
                ...
                const res = await client.post<AuthResponse>("/auth/youtube/callback", { code, state });
                if (res?.jwt) {
                ...
                setError(e?.error || "YouTube 回调处理失败");
            }
        })();
    }, [navigate]);
    ...
    return (
        <div className="fun-bg">
            <div className="container" style={{ maxWidth: 520 }}>
                <TopNav />
                <h1 className="heading">YouTube 登录处理中...</h1>
                {!error ? (
                    <div className="login-card">请稍候，正在完成 YouTube 授权...</div>
                ) : (
